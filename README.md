...
- **Relatórios**: Os resultados das execuções dos testes são disponibilizados no **GitHub Pages**, através do link: https://Rapha3la.github.io/ron-bugado-academy12.2-api-postman/report.html 📊
...
1. **Clone o repositório abaixo** para o seu ambiente local:
   ...
   https://github.com/Rapha3la/ron-bugado-academy12.2-api-postman.git
